			...
			<li>
			  ...
			  <form method="post" class="uk-form uk-form-horizontal" action="admin-post.php">
				...
				<div class="uk-form-row">
					...
					<div class="uk-form-controls">
						<input type="text" class="uk-form-width-large" name="textCash" id="textCash" placeholder="e.g. Pay cash onsite" value="'.$paymentArr["cash"]["text"].'"/>
					</div>
				</div>
				<hr />
				...
				<div class="uk-form-row">
					...
					<div class="uk-form-controls">
						<input type="text" class="uk-form-width-large" name="textOnInvoice" id="textOnInvoice" placeholder="e.g. Pay on invoice" value="'.$paymentArr["onInvoice"]["text"].'"/>
					</div>
				</div>			
				<div class="uk-form-row">
					<input class="button button-primary" type="submit" value="'.__('Save', 'advanced-booking-calendar').'" />
